...
//IMPLEMENT ANSWER SCENARIOS HERE

let scenario_1 = new question_node("",[answers_data.answers[1],answers_data.answers[0]],null);//SQL in Memory, SQL
let scenario_2 = new question_node("",[answers_data.answers[0]],null);                         //SQL
let scenario_3 = new question_node("",[answers_data.answers[2]],null);                         //NoSQL Document
let scenario_4 = new question_node("",[answers_data.answers[0],answers_data.answers[2]],null);//SQL, NoSQL Document
let scenario_5 = new question_node("",[answers_data.answers[6]],null);                         //NoSQL GraphDB
let scenario_6 = new question_node("",[answers_data.answers[1],answers_data.answers[4],answers_data.answers[2]],null);//SQL in Memory, NoSQl Column In Memory, NoSQL Document
let scenario_7 = new question_node("",[answers_data.answers[2]],null);//NoSQL Document
let scenario_8 = new question_node("",[answers_data.answers[4],answers_data.answers[2]],null);//NoSQL Colum In Memory, NoSQL Document
let scenario_9 = new question_node("",[answers_data.answers[5],answers_data.answers[2]],null);//NoSQL Column Store, NoSQL Document
let scenario_10 = new question_node("",[answers_data.answers[7]],null);                        //NoSQL Key Value
