    ...
    let card = ` <div id="item${index}" class="carousel-item w-100" >
                    <div class="mx-auto w-75 my-5">
                        ...
                        <div id="options${index}" class="mx-auto text-center">
                            <button id="${index*2+1}" type="button" class="mx-3 opciones opcion${index*2+1} btn-danger btn-lg opcion-select">OPC1</button>
                            <button id="${index*2+2}" type="button" class="mx-3 opciones opcion${index*2+2} btn-danger btn-lg opcion-select">OPC2</button>
                        </div>
                    </div>
                </div>`;
