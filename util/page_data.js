...
const index_text = {
    welcome: "¡Bienvenidos a la herramienta de recomendaciones de que base de datos utilizar!",
    objective: "La presente herramienta tiene como finalidad la recomendación de un motor de" +
                " base de datos mediante la aplicación. Esta simulación se dará mediante preguntas" +
                " específicas y con ello  se tomara la decisión de un camino en el cual tendrán como" +
